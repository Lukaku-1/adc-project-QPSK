...
```mermaid
flowchart TD
    A[Random Bits] --> B{QPSK Modulator} --> RRC Pulse Shaping --> Noisy Channel --> Synchronization Errors --> Matched Filter --> Timing Recovery --> Carrier Recovery --> QPSK Demodulator --> Recovered Bits --> BER & Constellation Analysis 
